...
public class SpawnChest : MonoBehaviour
{
    ...
    public void SetChestsParent()
    {
        ...
        tilesToSpawnChestsOn[rand].GetComponent<TileChestCheck>().PV.RPC("SetToTrue", RpcTarget.AllBuffered);
    }

    //public void DestroyChest()
    //{
    //    tilesToSpawnChestsOn[rand].GetComponent<TileChestCheck>().SetToFalse();
    //    PlayerPrefs.SetInt("random", 0);
    //    Destroy(chest);
    //    SpawningChestSequence();
